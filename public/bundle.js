...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = React.createClass({
		...
		componentDidMount: function componentDidMount() {
			...
			this.serverRequest = fetch('https://fcctop100.herokuapp.com/api/fccusers/top/recent').then(function (response) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// imports
	exports.push([module.id, "@import url(https://fonts.googleapis.com/css?family=Abril+Fatface|Lato:400,300,100);", ""]);
	  ...
	  render: function render() {
	    ...
	    for (var student in this.props.students) {
	      studentArray.push(React.createElement(
	        'div',
	        { className: 'card', key: student, onClick: this.onClick.bind(this, this.props.students[student].username) },
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'div',
	              { className: 'stats' },
	              React.createElement('svg', { className: 'icon', dangerouslySetInnerHTML: { __html: allTimeIcon } }),
	              this.props.students[student].alltime,
	              React.createElement('svg', { className: 'icon', dangerouslySetInnerHTML: { __html: recentIcon } }),
